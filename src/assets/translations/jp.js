let en = [
  {
    ...
    attributes: {
      ...
      short_description:
        "繊細さが加わったクラシックなクルーネックデザインTシャツ",
      long_description: [
        "特別でユニークな作品をご希望なら、スペシャルな女性たちがいます レディーエイプクラブ（LAC）スペシャルNFT！",
        "1万人いるレディーエイプクラブのうち10人しかいない特別で素敵な女性たちに会ってみてください！",
      ],
      hero_list: [
        "テンセル70%と綿30%の混用生地",
        "日本の細やかな技で作られた最高級品質の生地で、薄くて軽い肌触りが特徴",
        "単独着用はもちろん、インナーとしても老若男女誰にも似合う多用途性",
        "LAC NFTの中のスペシャル作品で、少数の特別な人々のための限定版製品として特別さを追求する方々に完璧な選択",
      ],
      list_description:
        "このTシャツは高品質の生地と繊細なデザインで製作され、優れた着用感と快適なスタイルをお届けします。",
      galery_image_path: [
      ...
      size_chart: {
        table_title: ["総丈", "総丈", "総丈", "腰回り"],
      },
      look_more: { title: "もっと見る" },
      packages: {
        title: "パッケージ構成",
        images: [
