let en = [
  {
    ...
    attributes: {
      ...
      long_description: [
        "Looking for art that really stands out?",
        "You’re in the right place––there’s a group of primates who’d love to meet you. ",
        "Introducing the Lady Ape Club (LAC) Special NFTs!",
        "An elite squad of just 10 among LAC’s 10,000 population, the Lady Ape Club Special NFTs are one girl gang you don’t want to miss!",
      ],
      hero_list: [
        "Ultra-limited run Lady Ape Club NFT tee",
        "Made using high-quality Japanese fabric",
        "Lightweight blend of 70% Tencel and 30% cotton",
        "Versatile, unisex design for styling alone or layering.",
      ],
      list_description:
        "Limited edition Lady Ape NFT crewneck tee. Made in Korea from Japanese fabric. Lightweight Tencel and cotton blend for superior comfort and style. ",
      galery_image_path: [
      ...
      size_chart: {
        table_title: ["Total length", "Shoulder width", "Chest", "Waist"],
      },
      look_more: { title: "Look around more" },
      packages: {
      ...
      product_impormation: {
        ...
        item: [
          ...
          "Japanese fabric",
          "Quality Guarantee",
          "Compliant with Korean online commerce law",
          "Country of Origin",
          "Korea",
          "Color",
          "White, black",
